...
import requests
import json
# import sqlite3 - Remplacé par MongoDB
...
# MongoDB utilisé au lieu de SQLite
# Configuration dans database/mongodb_connector.py et .env
...
def init_database():
    ...
    print("✅ MongoDB initialisé via mongodb_connector")
    return True

# Fonction remplacée par save_analysis_to_db_mongo dans mongodb_helpers.py
save_analysis_to_db = save_analysis_to_db_mongo

def save_analysis_to_db_OBSOLETE(results, filename, processing_time, session_id=None, ip_address=None, patient_id=None, patient_name=None, exam_date=None, doctor_id=None):
...
def get_current_doctor():
    """Obtenir les informations du médecin connecté depuis MongoDB"""
    if 'doctor_id' not in session:
        return None
...
def patient_profile(patient_id):
    ...
    try:
        ...
        alerts = get_patient_alerts_mongo( patient_id, doctor['id'])
